...
class InMemoryIdentityServiceTests {
    ...
    fun `assert ownership`() {
        ...
        val bob = PartyAndCertificate(Party(BOB.name, bobRootKey.public), bobRootCert, bobCertPath)
    ...
    private fun createParty(x500Name: X500Name, ca: CertificateAndKeyPair): Pair<PartyAndCertificate<Party>, PartyAndCertificate<AnonymousParty>> {
        ...
        return Pair(issuer, PartyAndCertificate(AnonymousParty(txKey.public), txCert, txCertPath))
    }
