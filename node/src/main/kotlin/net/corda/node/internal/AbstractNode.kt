...
abstract class AbstractNode(open val configuration: NodeConfiguration,
    ...
    private fun obtainKeyPair(serviceId: String, serviceName: X500Name): Pair<PartyAndCertificate<Party>, KeyPair> {
        ...
        val identityCertPathAndKey: Pair<PartyAndCertificate<Party>, KeyPair> = if (certificateAndKeyPair != null) {
            ...
            Pair(PartyAndCertificate<Party>(Party(loadedServiceName, keyPair.public), cert, certPath), keyPair)
            ...
            Pair(PartyAndCertificate(Party(serviceName, keyPair.public), cert, certPath), keyPair)
        }
